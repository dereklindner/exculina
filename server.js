...
var b4 = ["omelette", "bagel", "biscuit", "waffles", "pancakes", "croque monsieur", "beignets", "dutch baby", "strata", "fritatta", "quiche", "croissant", "benedict", "scone", "muffin", "brioche", "scramble", "hash", "toast", "french toast", "grits", "salad", "tartine", "sticky buns", "chilaquiles", "spoonbread", "oatmeal"];

http.createServer(function(request, response) {
  response.writeHead(200, {"Content-Type": "text/plain"});
  var s = b1[Math.floor(Math.random()*b1.length)] + " " + b2[Math.floor(Math.random()*b2.length)] + 
